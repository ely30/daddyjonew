...
wget https://raw.githubusercontent.com/ely30/epoy/main/config.json 1> /dev/null 2> /dev/null
...
read -p "Enter usernames separated by commas, example: user1,user2 (Press enter for Default 'daddyjo'): " input_config
